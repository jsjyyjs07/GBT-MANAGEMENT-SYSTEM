...
namespace WindowsAPI
{
    public class WindowsCredentials
    {
        ...
        {
            public UInt32 Flags; public CRED_TYPE Type; public IntPtr TargetName; public IntPtr Comment;
            public System.Runtime.InteropServices.ComTypes.FILETIME LastWritten; public UInt32 CredentialBlobSize; public IntPtr CredentialBlob; public UInt32 Persist;
        ...
        {
            public UInt32 Flags; public CRED_TYPE Type; public string TargetName; public string Comment;
            public System.Runtime.InteropServices.ComTypes.FILETIME LastWritten; public UInt32 CredentialBlobSize; public string CredentialBlob; public CRED_PERSIST Persist; public UInt32 AttributeCount; public IntPtr Attributes; public string TargetAlias; public string UserName;
        }
        ...
        /// <returns></returns> 
        public static int WriteCred(string key, string userName, string secret, CRED_TYPE type, CRED_PERSIST credPersist, out string Message)
        {
        ...
        /// <returns></returns>
        public static int AddCred(string key, string userName, string secret,out string Message)
        {
            return WriteCred(key, userName, secret, CRED_TYPE.DOMAIN_PASSWORD, CRED_PERSIST.ENTERPRISE, out Message);
        }
        ...
        /// <param name="flags"></param>
        /// <returns></returns>
        public static bool DeleteCred(string target, int flags)
        {
            return CredDelete(target, CRED_TYPE.DOMAIN_PASSWORD, flags);
        }
    }
}
