...
namespace WindowsAPI
{
    public class VideoAPI
    {
        ...
        public VideoAPI(IntPtr handle, int width, int height)         
        { 
        ...
        {
            byte[] lpszName = new byte[100]; byte[] lpszVer = new byte[100];
            ...
            {
                VideoAPI.SendMessage(lwndC, VideoAPI.WM_CAP_SET_PREVIEWRATE, 100, 0); VideoAPI.SendMessage(lwndC, VideoAPI.WM_CAP_SET_PREVIEW, true, 0);
            }
        }
